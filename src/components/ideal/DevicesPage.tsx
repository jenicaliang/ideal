...
const DEVICES = [
  {
    ...
    description: "A slim headband that monitors electrical activity during rest. Designed to feel like nothing.",
  ...
  },
  {
    ...
    description: "A dissolvable capsule that travels through the digestive tract, logging as it goes.",
  ...
  },
  {
    ...
    description: "Eye drops containing micro-sensors that adhere to the lens surface. Dissolved within 12 hours.",
  ...
  },
  {
    ...
    description: "A skin-tone adhesive patch, changed weekly. Monitors movement, posture, and skin response.",
